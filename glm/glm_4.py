...
for shift in [-4.5, -3.0, -1.5, 0.0]:
    ...
    keys = ['difficulty', 'cue', 'cue_left_right', 'error_difficulty', 'error_bias', 'left_minus_right']
    first_level_contrasts = ['hard - easy', 'cue_left - cue_right', 'cue_left + cue_right - 2 * cue_neutral', 'error', 'error', 'response_left - response_right']
    second_level_contrasts = ['ddm difficulty_effect', 'ddm z_cue_regressor', 'ddm z_cue_regressor', 'ddm
                              difficulty_effect', 'ddm z_cue_regressor', 'ddm z_cue_regressor']
